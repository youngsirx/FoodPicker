...
namespace FoodPicker.Helpers
{
    public class RestoImageUpload
    {
        ...
        private readonly string UploadPath = "~/RestoImages/";
        ...
        private Image Scale(Image imgPhoto)
        {
            ...
            if (Width != 0 && Height != 0)
            {
                ...
                //jkhalack: keep aspect ratio
                //try to scale to height first 
                float tryWidth = (float)(Height * sourceWidth) / sourceHeight;
                if (tryWidth > Width)
                {
                    //image is too wide to be scaled to height - scale to width
                    destWidth = Width;
                    destHeight = (float)(sourceHeight * Width / sourceWidth);
                }
                else
                {
                    //image will be scaled to height
                    destWidth = tryWidth;
                    destHeight = Height;
                }
            }
        ...
        private Image FixedSize(Image imgPhoto)
        {
